...
ReikaSystem treats the LLM as a candidate generator whose outputs carry no inherent authority,
routing all decision authority through an external, auditable control layer.
...
\textbf{Single-annotator pilot}: annotations were performed by the author;
independent annotation and multi-annotator agreement measurement are planned as future work.
...
This is the most speculative of the four correspondences and should be read as
a conceptual heuristic rather than a formal equivalence.
