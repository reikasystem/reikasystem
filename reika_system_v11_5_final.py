...
class Prism:
    ...
    Language note:
    The citation-presence check includes a few multilingual heuristics
    (e.g., Japanese year notation \d+年) alongside English-primary patterns.
    RF/GM observers remain primarily English-biased (see Language note in
    module docstring). Prism does not override that limitation; it adds only
    surface-structural checks that are partially language-agnostic.
    """
